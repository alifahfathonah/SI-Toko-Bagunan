    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="{{route('pembayaran.list', $sale->id)}}">Pembayaran</a>
                </li>
                <li class="separator">
                    <i class="flaticon-right-arrow"></i>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{route('pembayaransale.update', $payment->id)}}">
                        @method ('GET')
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control" value="{{number_format($new_bill, 2)}}" disabled>
                                    </div>
                                    <div class="form-group">
